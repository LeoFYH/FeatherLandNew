...
namespace BirdGame
{
    public class SettingPopup : UIBase
    {
        ...
        private void Update()
        {
            ...
            if (isVloumeExpend)
            {
                languageRect.anchoredPosition = new Vector2(0, languageY - 264 - (isScreenExpend ? 204 : 0));
            }
            else
            {
            ...
            moveHeight = (isScreenExpend ? 204 : 0) + (isVloumeExpend? 264 : 0) + (isLanguageExpend ? 105 : 0);
